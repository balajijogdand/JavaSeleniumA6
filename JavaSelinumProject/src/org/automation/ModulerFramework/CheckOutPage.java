...
public class CheckOutPage
{
	...
	public void buyingSmartPhone()
	{
		String city = Flib.getWorkbookCellValue("Register", 1, 0);
		String address = Flib.getWorkbookCellValue("Register", 1, 1);
		String zip = Flib.getWorkbookCellValue("Register", 1, 2);
		String phoneNo = Flib.getWorkbookCellValue("Register", 1, 3);
